...
### Comparison Plots
Combining and comparing plots using facets and stacked bar plots.

```{r compareSplit, message=FALSE, warning=FALSE}
...
total_results <-
  rbind(
    get_results(ini_file_26_SSP1, 2020, 2100, "SSP1 \nRCP 2.6"),
    get_results(ini_file_26_SSP5, 2020, 2100, "SSP5 \nRCP 2.6"),
    get_results(ini_file_19_SSP1, 2020, 2100, "SSP1 \nRCP 1.9"),
    get_results(ini_file_19_SSP5, 2020, 2100, "SSP5 \nRCP 1.9")
  )
```
